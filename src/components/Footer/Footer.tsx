        ...
        <div className="footer-grid">
          ...
          <div className="footer-col brand-col">
            ...
            <p className="brand-description">
              Providing compassionate, world-class healthcare to our community with dedication and clinical excellence for over 25 years.
            </p>
          ...
          <div className="footer-col contact-col">
            ...
            <ul className="footer-contact-details">
              ...
              <li>
                ...
                <span>care@medicare-hospital.com</span>
              </li>
            </ul>
          </div>
        </div>
